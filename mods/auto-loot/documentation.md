...
In other words, the Components and Valuables filters allow more granular control of the kinds of junk items you want to loot, so only one type of Junk filter can be enabled at a time.
