...
--- | --- | --- | --- | --- | --- | ---
`40edf98e-f577-4192-67cd-4f1776d14ea4` | `pa_kyrys_007` | Nurembergian cuirass | `2.5` | `2.5` | `1` | Ancient Map III<br>Can also be found after a certain battle
`4e0fbb0b-70c0-1ae3-da9c-fc74e2512193` | `pa_brigandine_009` | Dark Milanese brigandine | `2.43` | `2.43` | `0.972` | Duel prize
`4d3eb06c-581c-72a2-acf5-07c56cbb47b4` | `pa_brigandine_009` | Dyed Milanese brigandine | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer<br>Duel prize?
`4c8f4d4b-72d3-c337-ed0c-41225e7b2382` | `pa_brigandine_009` | Dyed Milanese brigandine | `2.43` | `2.43` | `0.972` | Duel prize?
`4964faf4-b122-9856-e3d4-7e026ce4a0a7` | `pa_brigandine_009` | Dyed Milanese brigandine | `2.43` | `2.43` | `0.972` | Duel prize?
`440074cf-4d3d-5d80-2944-f49d91d642a1` | `pa_brigandine_009` | Dyed Milanese brigandine | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer<br>Duel prize?
`4222ca69-3a10-91c1-91ff-26f36122b8a2` | `pa_brigandine_009` | Bright Milanese brigandine | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer
`41e550e4-12df-49f0-3b05-74959224a8a5` | `pa_brigandine_009` | Milanese brigandine | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer
`481cfd5b-b646-1c6b-ff58-af749941cf9e` | `pa_helmet_024` | Warhorse helmet | `2.4` | `2.4` | `0.96` |
`4fedd7a1-ac86-40b1-ba0b-847e602df774` | `pa_kyrys_011` | Vitus' cuirass | `2.35` | `2.35` | `0.94` |
`4c71ff43-0696-66e4-71d9-45f30cf05392` | `pa_kyrys_008` | Noble cuirass | `2.35` | `2.35` | `0.94` |
`42ed6b9c-19c5-0b8c-5feb-bfe0d7001997` | `pa_arm_016` | Magdeburg plate pauldrons | `2.3` | `2.3` | `0.92` | Sold by Rattay Armourer
`421f173c-99b2-f030-cedd-0ba2a25270ac` | `pa_helmet_024` | Arching bascinet | `2.29` | `2.29` | `0.916` | Treasure Map IV<br>Bandit loot
`47b8a5a6-0912-c070-49b9-d126e8c55bbd` | `pa_kyrys_009` | Magdeburg cuirass | `2.28` | `2.28` | `0.912` |
`4bef1aa8-1d05-6ecc-7797-083fa321cf80` | `pa_brigandine_009_bonus` | Warhorse brigandine | `2.2` | `2.2` | `0.88` |
`47d11f76-1007-00c0-1c63-cfb2b02b0c80` | `pa_kyrys_010` | Kuttenberg cuirass | `2.2` | `2.2` | `0.88` | 
...
`40c05582-26f8-b1dc-f0ba-80e717a8869e` | `pa_kyrys_005` | Decorated cuirass | `2.13` | `2.13` | `0.852` |
`4dc120cc-1a9c-aaf4-939a-c843e2ea2394` | `pa_legs_015` | Magdeburg plate chausses | `2.1` | `2.1` | `0.84` | Treasure Map III
`4516652a-7e40-d46d-cdd7-62ea97c3bb83` | `pa_arm_020` | Augsburg plate pauldrons | `2.1` | `2.1` | `0.84` | Sold by Rattay Armourer
`481b929a-0e8e-05da-54c5-2939bd72e594` | `pa_helmet_015` | Italian bascinet | `2.07` | `2.07` | `0.828` | Sold by Rattay Armourer
`4ab8c97d-6977-4b6c-4d66-86b471549483` | `pa_kyrys_001` | Milanese cuirass | `2.05` | `2.05` | `0.82` | Sold by Rattay Armourer<br>Sold by Merhojed army camp armourer<br>Sold by unknown merchant
...
--- | --- | --- | --- | --- | --- | --- | ---
`4bef1aa8-1d05-6ecc-7797-083fa321cf80` | `pa_brigandine_009_bonus` | Warhorse brigandine | `20` | `2.2` | `2.2` | `0.88` |
`4516652a-7e40-d46d-cdd7-62ea97c3bb83` | `pa_arm_020` | Augsburg plate pauldrons | `20` | `2.1` | `2.1` | `0.84` | Sold by Rattay Armourer
`48a827cd-c6ea-4976-9561-327a122326b7` | `pa_legs_018` | Augsburg plate chausses | `20` | `2.02` | `2.02` | `0.808` |
`422917fc-435a-f436-3245-a356367f8881` | `pa_arm_017` | Milanese plate pauldrons | `19` | `2` | `2` | `0.8` | Sold by Rattay Armourer
`481cfd5b-b646-1c6b-ff58-af749941cf9e` | `pa_helmet_024` | Warhorse helmet | `18` | `2.4` | `2.4` | `0.96` |
...
`40c05582-26f8-b1dc-f0ba-80e717a8869e` | `pa_kyrys_005` | Decorated cuirass | `17` | `2.13` | `2.13` | `0.852` |
`40edf98e-f577-4192-67cd-4f1776d14ea4` | `pa_kyrys_007` | Nurembergian cuirass | `16` | `2.5` | `2.5` | `1` |
`47b8a5a6-0912-c070-49b9-d126e8c55bbd` | `pa_kyrys_009` | Magdeburg cuirass | `16` | `2.28` | `2.28` | `0.912` |
`4ab8c97d-6977-4b6c-4d66-86b471549483` | `pa_kyrys_001` | Milanese cuirass | `16` | `2.05` | `2.05` | `0.82` | Sold by Rattay Armourer<br>Sold by Merhojed army camp armourer<br>Sold by unknown merchant
`4964faf4-b122-9856-e3d4-7e026ce4a0a7` | `pa_brigandine_009` | Dyed Milanese brigandine | `15` | `2.43` | `2.43` | `0.972` |
`4222ca69-3a10-91c1-91ff-26f36122b8a2` | `pa_brigandine_009` | Bright Milanese brigandine | `15` | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer
`421f173c-99b2-f030-cedd-0ba2a25270ac` | `pa_helmet_024` | Arching bascinet | `15` | `2.29` | `2.29` | `0.916` |
`4e0fbb0b-70c0-1ae3-da9c-fc74e2512193` | `pa_brigandine_009` | Dark Milanese brigandine | `14` | `2.43` | `2.43` | `0.972` | 
`4d3eb06c-581c-72a2-acf5-07c56cbb47b4` | `pa_brigandine_009` | Dyed Milanese brigandine | `14` | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer
`4c8f4d4b-72d3-c337-ed0c-41225e7b2382` | `pa_brigandine_009` | Dyed Milanese brigandine | `14` | `2.43` | `2.43` | `0.972` |
...
`4c71ff43-0696-66e4-71d9-45f30cf05392` | `pa_kyrys_008` | Noble cuirass | `14` | `2.35` | `2.35` | `0.94` |
`4dc120cc-1a9c-aaf4-939a-c843e2ea2394` | `pa_legs_015` | Magdeburg plate chausses | `14` | `2.1` | `2.1` | `0.84` |
`41e550e4-12df-49f0-3b05-74959224a8a5` | `pa_brigandine_009` | Milanese brigandine | `13` | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer
`47d11f76-1007-00c0-1c63-cfb2b02b0c80` | `pa_kyrys_010` | Kuttenberg cuirass | `12` | `2.2` | `2.2` | `0.88` |
`481b929a-0e8e-05da-54c5-2939bd72e594` | `pa_helmet_015` | Italian bascinet | `10` | `2.07` | `2.07` | `0.828` | Sold by Rattay Armourer

## Status / Slash Def / Stab Def

Item UUID | Clothing Name | Item Name | Max Status | Slash Def | Stab Def | Smash Def | Location
--- | --- | --- | --- | --- | --- | --- | ---
`40edf98e-f577-4192-67cd-4f1776d14ea4` | `pa_kyrys_007` | Nurembergian cuirass | `80` | `2.5` | `2.5` | `1` | Ancient Map III<br>Can also be found after a certain battle
`481cfd5b-b646-1c6b-ff58-af749941cf9e` | `pa_helmet_024` | Warhorse helmet | `80` | `2.4` | `2.4` | `0.96` | 
`42ed6b9c-19c5-0b8c-5feb-bfe0d7001997` | `pa_arm_016` | Magdeburg plate pauldrons | `80` | `2.3` | `2.3` | `0.92` | Sold by Rattay Armourer
`4dc120cc-1a9c-aaf4-939a-c843e2ea2394` | `pa_legs_015` | Magdeburg plate chausses | `80` | `2.1` | `2.1` | `0.84` | Sold by merchants<br>Treasure Map III
`4e0fbb0b-70c0-1ae3-da9c-fc74e2512193` | `pa_brigandine_009` | Dark Milanese brigandine | `78` | `2.43` | `2.43` | `0.972` | Duel prize
`4d3eb06c-581c-72a2-acf5-07c56cbb47b4` | `pa_brigandine_009` | Dyed Milanese brigandine | `78` | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer<br>Duel prize?
