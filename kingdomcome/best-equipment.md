...
--- | --- | --- | --- | --- | --- | ---
`40edf98e-f577-4192-67cd-4f1776d14ea4` | `pa_kyrys_007` | Nurembergian cuirass | `2.5` | `2.5` | `1` | Ancient Map III / Can also be found after a certain battle
`4e0fbb0b-70c0-1ae3-da9c-fc74e2512193` | `pa_brigandine_009` | Dark Milanese brigandine | `2.43` | `2.43` | `0.972` | Sold by merchants / Can also be won in a duel
`4d3eb06c-581c-72a2-acf5-07c56cbb47b4` | `pa_brigandine_009` | Dyed Milanese brigandine | `2.43` | `2.43` | `0.972` | Sold by merchants / Can also be won in a duel
`4c8f4d4b-72d3-c337-ed0c-41225e7b2382` | `pa_brigandine_009` | Dyed Milanese brigandine | `2.43` | `2.43` | `0.972` | Sold by merchants / Can also be won in a duel
`4964faf4-b122-9856-e3d4-7e026ce4a0a7` | `pa_brigandine_009` | Dyed Milanese brigandine | `2.43` | `2.43` | `0.972` | Sold by merchants / Can also be won in a duel
`440074cf-4d3d-5d80-2944-f49d91d642a1` | `pa_brigandine_009` | Dyed Milanese brigandine | `2.43` | `2.43` | `0.972` | Sold by merchants / Can also be won in a duel
`4222ca69-3a10-91c1-91ff-26f36122b8a2` | `pa_brigandine_009` | Bright Milanese brigandine | `2.43` | `2.43` | `0.972` |
`41e550e4-12df-49f0-3b05-74959224a8a5` | `pa_brigandine_009` | Milanese brigandine | `2.43` | `2.43` | `0.972` |
...
`42ed6b9c-19c5-0b8c-5feb-bfe0d7001997` | `pa_arm_016` | Magdeburg plate pauldrons | `2.3` | `2.3` | `0.92` | Sold by merchants
`421f173c-99b2-f030-cedd-0ba2a25270ac` | `pa_helmet_024` | Arching bascinet | `2.29` | `2.29` | `0.916` | Treasure Map IV / Can also be found as bandit loot
...
`47a86203-78c8-463a-6ce6-4b22754786ba` | `pa_arm_014` | Meissen plate pauldrons | `2.2` | `2.2` | `0.88` | 
`4a0b54a0-f893-122d-5171-74ac68e933ad` | `pa_helmet_006` | Hounskull | `2.18` | `2.18` | `0.872` |
`40c05582-26f8-b1dc-f0ba-80e717a8869e` | `pa_kyrys_005` | Decorated cuirass | `2.13` | `2.13` | `0.852` |
`4dc120cc-1a9c-aaf4-939a-c843e2ea2394` | `pa_legs_015` | Magdeburg plate chausses | `2.1` | `2.1` | `0.84` | Sold by merchants / Treasure Map III
`4516652a-7e40-d46d-cdd7-62ea97c3bb83` | `pa_arm_020` | Augsburg plate pauldrons | `2.1` | `2.1` | `0.84` | 
...
`4dc120cc-1a9c-aaf4-939a-c843e2ea2394` | `pa_legs_015` | Magdeburg plate chausses | `80` | `2.1` | `2.1` | `0.84` | Sold by merchants / Treasure Map III
`4e0fbb0b-70c0-1ae3-da9c-fc74e2512193` | `pa_brigandine_009` | Dark Milanese brigandine | `78` | `2.43` | `2.43` | `0.972` | Sold by merchants / Can also be won in a duel
`4d3eb06c-581c-72a2-acf5-07c56cbb47b4` | `pa_brigandine_009` | Dyed Milanese brigandine | `78` | `2.43` | `2.43` | `0.972` | Sold by merchants / Can also be won in a duel
`4c8f4d4b-72d3-c337-ed0c-41225e7b2382` | `pa_brigandine_009` | Dyed Milanese brigandine | `78` | `2.43` | `2.43` | `0.972` | Sold by merchants / Can also be won in a duel
`4964faf4-b122-9856-e3d4-7e026ce4a0a7` | `pa_brigandine_009` | Dyed Milanese brigandine | `78` | `2.43` | `2.43` | `0.972` | Sold by merchants / Can also be won in a duel
`440074cf-4d3d-5d80-2944-f49d91d642a1` | `pa_brigandine_009` | Dyed Milanese brigandine | `78` | `2.43` | `2.43` | `0.972` | Sold by merchants / Can also be won in a duel
...
`421f173c-99b2-f030-cedd-0ba2a25270ac` | `pa_helmet_024` | Arching bascinet | `78` | `2.29` | `2.29` | `0.916` | Treasure Map IV / Can also be found as bandit loot
