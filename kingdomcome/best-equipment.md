...
`ArmsPlateBackGuardsShort` | `42ed6b9c-19c5-0b8c-5feb-bfe0d7001997` | `pa_arm_016` | Magdeburg plate pauldrons | `18` | `2.3` | `2.3` | `0.92` | Sold by Rattay Armourer
`ArmsPlateBackGuardsShort` | `47a86203-78c8-463a-6ce6-4b22754786ba` | `pa_arm_014` | Meissen plate pauldrons | `18` | `2.2` | `2.2` | `0.88` | Sold by Rattay Armourer
...
`BodyPlateCuirassFullShort` | `40edf98e-f577-4192-67cd-4f1776d14ea4` | `pa_kyrys_007` | Nurembergian cuirass | `16` | `2.5` | `2.5` | `1` | Ancient Map III (Treasures of the Past DLC)<br>Can also be found after a certain battle
`BodyPlateCuirassFullShort` | `47b8a5a6-0912-c070-49b9-d126e8c55bbd` | `pa_kyrys_009` | Magdeburg cuirass | `16` | `2.28` | `2.28` | `0.912` | Treasure map XVI
`BodyPlateCuirassFullShort` | `4ab8c97d-6977-4b6c-4d66-86b471549483` | `pa_kyrys_001` | Milanese cuirass | `16` | `2.05` | `2.05` | `0.82` | Lord Divish<br>Sold by Rattay Armourer<br>Sold by Merhojed army camp armourer<br>Sold by unknown merchant
`BodyPlateCuirassFullShort` | `4964faf4-b122-9856-e3d4-7e026ce4a0a7` | `pa_brigandine_009` | Dyed Milanese brigandine | `15` | `2.43` | `2.43` | `0.972` | Treasure map V
`BodyPlateCuirassFullShort` | `4222ca69-3a10-91c1-91ff-26f36122b8a2` | `pa_brigandine_009` | Bright Milanese brigandine | `15` | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer<br>Treasure map XXI
`BodyPlateCuirassFullShort` | `4e0fbb0b-70c0-1ae3-da9c-fc74e2512193` | `pa_brigandine_009` | Dark Milanese brigandine | `14` | `2.43` | `2.43` | `0.972` | Treasure map XXII
`BodyPlateCuirassFullShort` | `4d3eb06c-581c-72a2-acf5-07c56cbb47b4` | `pa_brigandine_009` | Dyed Milanese brigandine | `14` | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer<br>q_counterOffensive_pirk_chest
`BodyPlateCuirassFullShort` | `4c8f4d4b-72d3-c337-ed0c-41225e7b2382` | `pa_brigandine_009` | Dyed Milanese brigandine | `14` | `2.43` | `2.43` | `0.972` | Treasure map V
`BodyPlateCuirassFullShort` | `440074cf-4d3d-5d80-2944-f49d91d642a1` | `pa_brigandine_009` | Dyed Milanese brigandine | `14` | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer
`BodyPlateCuirassFullShort` | `4c71ff43-0696-66e4-71d9-45f30cf05392` | `pa_kyrys_008` | Noble cuirass | `14` | `2.35` | `2.35` | `0.94` | Treasure map II<br>Treasure map XIII
`BodyPlateCuirassFullShort` | `41e550e4-12df-49f0-3b05-74959224a8a5` | `pa_brigandine_009` | Milanese brigandine | `13` | `2.43` | `2.43` | `0.972` | Sold by Rattay Armourer
`BodyPlateCuirassFullShort` | `47d11f76-1007-00c0-1c63-cfb2b02b0c80` | `pa_kyrys_010` | Kuttenberg cuirass | `12` | `2.2` | `2.2` | `0.88` | Treasure map VII<br>q_escape_from_Vranik_4
...
`HeadPlateHelmFull_collar` | `481b929a-0e8e-05da-54c5-2939bd72e594` | `pa_helmet_015` | Italian bascinet | `10` | `2.07` | `2.07` | `0.828` | Sold by Rattay Armourer<br>Treasure map XXV<br>q_konradk_fejfar_chest
...
Archetype | UUID | Item Name | Localized Name | Noi | Con | Vis | Location
:--- | :--- | :--- | :--- | ---: | ---: | ---: | :---
`HandsGloves` | `4765b22e-ac12-f985-ebfe-19f9c7e37481` | `gloves_001` | Leather gloves | `0` | `-0.92` | `-0.92` | Sold by Rattay armourer
`LegsClothTrousersLong` | `473110cf-b888-a84b-7c65-e5b1beab47ac` | `pants_005_dark` | Tight red hose | `0` | `-0.81` | `-0.82` | Sold by Sassau tailor
`Tmp_HoodOn` | `4dd34997-a8f3-9f9f-ddaa-ca0ca4b07c9f` | `hood_001_down_bandits_03` | Black hood | `0` | `-0.77` | `-0.88` | Sold by Sassau tailor
`FeetBoots` | `4a0742c5-ec0d-b5d5-dadc-b5e9776e22bb` | `boots_013_c2` | Quiet dark shoes | `0` | `-0.76` | `-0.72` | Sold by Rattay shoemaker
`BodyClothShirtLong_longSleeves` | `4517b07b-ca19-07bf-6011-e2cec8868185` | `gambeson_08_m1_c4` | Dark Saxon gambeson | `0` | `-0.74` | `-0.84` | Sold by Rattay armourer
`FeetBoots` | `4cee3ad0-5249-8bc6-de75-a00f4e4b0d8e` | `boots_013` | Silent shoes | `0` | `-0.7` | `-0.66` | Sold by Rattay shoemaker
`BodyClothShirtLong_longSleeves` | `490d57d4-3e96-3a75-96ca-54cb52c6f6ab` | `gambeson_02_c2` | Light tarred jacket | `0.022` | `-0.81` | `-0.82` | 
`BodyClothShirt_longSleeves` | `4deb11fd-f319-17b9-8d46-27f7f3d7a7a3` | `gambeson_07_c1` | Dark Silesian gambeson | `0.03` | `-0.71` | `-0.56` | Sold by Rattay armourer
`HeadClothCap` | `42de552f-eaac-ee43-5e36-129615d2b4ab` | `g_hood_001_c6` | Padded coif | `0.08` | `-0.74` | `-0.74` | Sold by Sassau tailor
`Robe` | `457ca6d3-b64a-66b8-4c1e-fd606a6530af` | `monk_coat_003` | Monk's habit | `0.08` | `-0.74` | `-0.7` | 
`Tmp_HoodDown` | `4d83cddb-a7ce-dfd5-d2d0-aa7454313f8d` | `hood_002_down_bandits` | Black hood | `0.08` | `-0.69` | `-0.7` | 
`LegsClothTrousersLong` | `486fb98b-9cbe-79dd-314a-ac379dfc96b3` | `pants_001_miparty_03_C2` | Decorated black hose | `0.08` | `-0.33` | `-0.62` | 
`LegsClothTrousersLong` | `4903be20-7d0c-ca13-5a9b-4ab2fd5a10bd` | `pants_006_color_var_B_straps` | Green nobleman's hose | `0.082` | `-0.38` | `-0.62` | Sold by Sassau tailor
`FeetBoots` | `4f4b2cdc-1690-4e32-bba8-00eff2f14f0c` | `pickpocket_reward_boots` | Slippers | `0.084` | `-0.31` | `-0.48` | Quest reward: Green-Eyed Monster
`HandsGloves` | `49f22875-6f21-0d2c-fc78-11fa556779b4` | `gloves_002` | Hunter's gloves | `0.1` | `-0.74` | `-0.74` | Sold by Rattay huntsman<br>Sold by Talmberg huntsman<br>q_counterOffensive_pirk_chest<br>q_escapeToTalmberk_soldiersLocker<br>sazava_monastery_urba_konrad_keyser_chest
...
`LegsClothTrousersLong` | `473110cf-b888-a84b-7c65-e5b1beab47ac` | `pants_005` | Tight red hose | `-0.81` | `-0.82` | `0` | Sold by Sassau tailor
`Tmp_HoodOn` | `4dd34997-a8f3-9f9f-ddaa-ca0ca4b07c9f` | `hood_001` | Black hood | `-0.77` | `-0.88` | `0` | Sold by Sassau tailor
`FeetBoots` | `4a0742c5-ec0d-b5d5-dadc-b5e9776e22bb` | `boots_011` | Quiet dark shoes | `-0.76` | `-0.72` | `0` | Sold by Rattay shoemaker
`BodyClothShirtLong_longSleeves` | `4517b07b-ca19-07bf-6011-e2cec8868185` | `s1_gambeson_08_s1` | Dark Saxon gambeson | `-0.74` | `-0.84` | `0` | Sold by Rattay armourer
...
`Robe` | `457ca6d3-b64a-66b8-4c1e-fd606a6530af` | `monk_coat` | Monk's habit | `-0.74` | `-0.7` | `0.08`
`BodyClothShirt_longSleeves` | `4deb11fd-f319-17b9-8d46-27f7f3d7a7a3` | `s1_gambeson_07` | Dark Silesian gambeson | `-0.71` | `-0.56` | `0.03` | Sold by Rattay armourer
`FeetBoots` | `4cee3ad0-5249-8bc6-de75-a00f4e4b0d8e` | `boots_011` | Silent shoes | `-0.7` | `-0.66` | `0` | Sold by Rattay shoemaker
