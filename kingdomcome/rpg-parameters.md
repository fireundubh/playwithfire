...
# RPG Parameters
**Data Quality Note:** The <font color="red">following</font> descriptions were dumped directly from the game. The parameter names are correct, but the descriptions contain typos and misspellings. They will be cleaned up later.
...
CharismaMulOnExtremeExhaustionInterpolation | nil |  | nil |  | nil | Removed? Probably renamed
...
ImprovedSleepMultiplierSurvival | nil |  | nil |  | nil | Removed? Probably renamed
...
InactiveTimeToDestroyOversleepCreated | nil |  | nil |  | nil | Removed? Probably renamed
...
ReadingRestEffectiveness | 0.300000000 | Removed | nil |  | nil | If this value is 0.3, reading will regen player as sleeping on bed with comfort 30%.
ReadingRestUpperLimit | 1.000000000 | Removed | nil |  | nil | When sleeping, the rest can not exceed bed quality. When reading, the threshold is given by this value.
