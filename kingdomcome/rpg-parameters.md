...
AgiDiffToAttackSpeed | 0.200000 | Relative attack speed gain for one Agility level difference
AgilityXPLevelBase | 20.000000 | 
AgilityXPLevelDiff | 30.000000 | 
AimCiriticalLimitTime | 0.750000 | Time limit after AI is notified about low Stamina when aiming
AimPainlessDelay | 2.000000 | Aiming without Stamina loss
AimSkillToZoom | 1.500000 | Zoom increase by each skill level above the base
AimSpreadMax | 10.000000 | Aiming spread due to low Stamina and skill. Max angle. Used right before all Stamina is lost.
AimSpreadMinRatio | 0.300000 | Aiming spread minimum, relative to max. This value is used after entering the painless zone.
AimSpreadSkillDecrease | 0.050000 | Relative decrease of maximum aim spread for each skill level
AimStamCost | 20.000000 | Stamina loss after after painless delay
AimZoomBase | 10.000000 | aim zoom (=fov decrease) after reaching some skill level
AimZoomBaseSkill | 10.000000 | Minimal skill level required to benefit from the zoom effect
AimZoomMax | 25.000000 | maximal aim zoom (=fov decrease)
AlchemyRecipeStepsTolerance | 2.000000 | How many recipe steps might fail in order to successfully brew the recipe
...
AlcoholDigestSpeedModfifOnEmptyStomache | 2.000000 | Alcohol digest speed multiplier on empty stomache
AlcoholDigestSpeedModfifOnFullStomache | 0.500000 | Alcohol digest speed multiplieron full stomache
AlcoholDrunkMaxExhaustNegativeEffect | 0.005000 | Max negative exhaustion effect while drunk
AlcoholDrunkThreshold | 0.500000 | Threshold for Drunkenness mood from max alcohol poisoning
...
AlcoholMaxCHAEffect | 2.000000 | Max negative/positive stat effect
AlcoholMaxCONEffect | 3.000000 | Max negative/positive stat effect
AlcoholMaxDrinkingSkillHangoverDurationModifier | 0.333333 | Hangover duration modifier for max Drinking skill
AlcoholMaxSPCEffect | 2.000000 | Max negative/positive stat effect
AlcoholMaxSTREffect | 2.000000 | Max negative/positive stat effect
AlcoholMaxVITEffect | 2.000000 | Max negative/positive stat effect
AlcoholMoodMaxExhaustPossitiveEffect | 0.000200 | max positive exhaust effect while in mood
AlcoholMoodThreshold | 0.010000 | threshold for alcohol mood from max alcohol poisoning
AlcoholPerkBacchusHangoverEffectMod | 1.300000 | hangover effects mod
AlcoholPerkCorrectResistanceModif | 0.500000 | alcohol content modif for correct resistance
AlcoholPerkDrunkHangoverDurationMod | 2.000000 | 
AlcoholPerkDrunkMoodRangeMod | 2.000000 | mood range is expanded by this mod
AlcoholPerkLooseTongueSpcChaModif | 1.500000 | speech and charisma modif bonus/malus for loose tongue perk
...
ArmorLoadToRun | 0.500000 | how armor load coefficient affects running speed
ArmorLoadToSprint | 1.000000 | how armor load coefficient affects sprint
ArmorStatusToCharismaCoef | 0.670000 | 
ArmorStatusToDefenseCoef | 0.200000 | health to armor defense multiplicative coef
AthleticXPAwardDistance | 500.000000 | award xp for travelling some distance
AttackEnergyModifier | 2.000000 | utoku
...
AverageArmorDefenseWeight | 0.500000 | 0 = only body part defense, 1 = only average defense
AvidReaderReadingSpeed | 0.350000 | AvidReader soul ability advances reading progress on one book in inventory during sleep or skiptime. This constant determines speed of reading (reading spot is always None).
BadassnessDiffToSkillCheckResult | 2.000000 | 
BarterAngrynessCoefWeightA | 1.000000 | 
BarterAngrynessCoefWeightB | 0.700000 | 
BarterCoefWeightA | 0.875000 | shopkeeper shop barter calculation 'a' coef
BarterCoefWeightB | 80.000000 | shopkeeper shop barter calculation 'b' coef
BarterDominanceChaBaseE | 5.000000 | barter dominance calculation 'e' coef
BarterDominanceChaWeightC | 0.100000 | barter dominance calculation 'c' coef
BarterDominanceRelationshipWeightB | 1.000000 | barter dominance calculation 'b' coef
BarterDominanceSpcWeightA | 3.000000 | barter dominance calculation 'a' coef
BarterDominanceSpcWeightD | 10.000000 | barter dominance calculation 'd' coef
BarterPriceSellRepBuying | 1.500000 | price sell vs buy mod
BarterPriceSellRepCoef | 1.500000 | sell reputation coef
BarterPriceSellRepMultip | -0.500000 | sell reputation multiplier
BaseAttackStaminaCost | 12.000000 | how much stamina will attack cost
BaseInventoryCapacity | 66.000000 | base inventory capacity
BaseItemDisappearingTime | 3600.000000 | base game time for dropped items to auto disappear
BasketSuspiciencyNoDealThreashold | 10000000.000000 | Haggle reaction 2 threshold (transaction refused)
...
CharismaMulOnExtremeExhaustion | 0.750000 | Player will have this charisma multiplied by this value when he has exhaust equal to 0. Charisma will not be changed when exhaust is 50. Linear interpolation on multiplier is applied when exhaust is between 0 and 50;
ClassCourageMoraleWeight | 0.000000 | Weight of soul class courage affecting morale
ClothDirtyingUpdatePeriod | 50.000000 | how often (in meters walked) do we add dirt to clothing (both for player and NPCs)
CollisionVelocityDeltaToDmgR | 0.250000 | 
CombatAutoAggressionDiffScale | 2.000000 | the bigger number the bigger difference in aggresion for skill differnce
CombatAutoAttackDelayIncreasePerAttacker | 0.500000 | how many times is the period increased for each attacker
CombatAutoAttackDelayIncreasePerAttackerHorse | 0.100000 | CombatAutoAttackDelayIncreasePerAttacker if the victim is on horse
CombatAutoAttackDelayIncreasePerAttackerMissile | 0.200000 | CombatAutoAttackDelayIncreasePerAttacker if the victim has a missile wpn
CombatAutoAttackDelaySigma | 4.000000 | attack delay variation
CombatAutoClinchReactionDelayMaxMax | 1.000000 | maximal maximum
CombatAutoClinchReactionDelayMaxMin | 0.500000 | maximal minimum
CombatAutoClinchReactionDelayMinMax | -0.500000 | minimal maximum
CombatAutoClinchReactionDelayMinMin | -1.000000 | minimal minimum
CombatAutoComboStepsSigma | 1.500000 | standard deviation of performed combo steps
CombatAutoDodgeWeight | 1.100000 | 
CombatAutoEasyZoneWeight | 0.800000 | [0-1] how much are easy zones favored by the lame AI (1 = favored)
CombatAutoForcedComboStaminaLimit | 0.700000 | stamina threshold
CombatAutoForcedPeriodicalAttackStaminaLimit | 0.200000 | stamina threshold
CombatAutoGuardHysteresis | 1.500000 | 
CombatAutoLameGuardOffset | 3.000000 | offset to max distance
CombatAutoMasterComboSteps | 5.000000 | combo steps a skilled npc will typically perform
CombatAutoMasterGuardOffset | 1.000000 | offset to max distance
CombatAutoMaxAimDuration | 3.000000 | the longest aim time for the lowest skill
CombatAutoMaxAimDurationRandomAdd | 1.000000 | max random time added to the aim duration
CombatAutoMaxAtkDistOffset | 0.100000 | offset from max attack distance defined in percentage from attack range
CombatAutoMaxAttackDelay | 5.000000 | mean delay between attacks for a defensive AI
CombatAutoMaxHuntAttackDuration | 60.000000 | maximal time the NPC is hunting/chasing
CombatAutoMinAtkDistOffset | 0.000000 | offset from min attack distance defined in percentage from attack range
CombatAutoMinDefenseModeWeight | 0.400000 | [0-1] the lowest weight for the defense mode
CombatAutoMinHuntAttackDuration | 15.000000 | minimal time the NPC is hunting/chasing
CombatAutoMoveActivityDecreasePerAttacker | 0.500000 | my activity decrease per opponents aditinal attackers
CombatAutoNaturalComboRatio | 0.500000 | [0-1] ratio of natural combos
CombatAutoNoDefenseWeight | 0.400000 | 
CombatAutoNormalBWeight | 2.800000 | 
CombatAutoOppZoneAdaptDelayMaxMax | 2.000000 | reaction delay maximal maximum
CombatAutoOppZoneAdaptDelayMaxMin | 1.000000 | reaction delay maximal minimum
CombatAutoOppZoneAdaptDelayMinMax | 0.200000 | reaction delay minimal maximum
CombatAutoOppZoneAdaptDelayMinMin | 0.000000 | reaction delay minimal minimum
CombatAutoPBWeight | 2.000000 | 
CombatAutoReactionDelayRangeSpread | 0.300000 | [0-1] higher nunber -> changes state less often
CombatAutoReactivePreblockMaxDelay | 0.800000 | 
CombatAutoReactivePreblockMinDelay | 0.300000 | 
CombatAutoRiposteAggressionWeight | 0.500000 | 
CombatAutoScaleDefensivenessDelayRel | 2.000000 | relative to attack delay, time to override defensiveness and go near
CombatAutoSPBWeight | 0.750000 | 
CombatAutoStaticPreblockMaxTime | 15.000000 | 
CombatAutoStaticPreblockRandBias | 0.800000 | 
CombatAutoTrickAttackProb | 0.800000 | [0-1] attack prob for the first step
CombatAutoTrickDelayVariability | 0.300000 | added to the lower bound
CombatAutoTrickInvalidBlockAttackMaxProb | 0.500000 | [0-1] max trick prob for a skilled AI if the block is invalid
CombatAutoTrickMaxProb | 0.500000 | [0-1] max trick prob for the first step
CombatAutoTrickMinMaxDelay | 0.800000 | lower bound of the max delay
CombatAutoTrickNoAttackProb | 0.100000 | [0-1] no attack prob for the first step
...
CombatAutoZoneChangeDelayMaxMax | 10.000000 | zone change timeout maximal maximum
CombatAutoZoneChangeDelayMaxMin | 5.000000 | zone change timeout maximal minimum
CombatAutoZoneChangeDelayMinMax | 6.000000 | zone change timeout minimal maximum
CombatAutoZoneChangeDelayMinMin | 2.000000 | zone change timeout minimal minimum
CombatDangerCooldown | 3.000000 | how long is the combat danger active after last enemy stops to be a threat
CombatDmgRBonusFromBehind | 1.200000 | multiplicative DmgR bohus for attacks from behind
CombatHitImmortalUnconsciousDepth | 120.000000 | depth for immortal knock-out
...
DistanceCheckInterval | 1.000000 | check distance travelled for statistics
DmgRToHealthCoefA | 3.000000 | 
DmgRToHealthCoefB | 1.600000 | 
DuringFaderHysteresis | 1.000000 | the in-fader state is kept for how longer
...
ExhaustedPlayerEffectMinMin | 10.000000 | the shortest interval between effects for low exhaust stat
ExhaustedThreshold | 50.000000 | player will have the 'exhausted' debuff when 'exhaust' stat is lower or equal to this value (in percents)
ExhaustionSpeed | 0.000579 | amount of energy/vigour 'lost' per world-time second (global base value)
ExtremeExhaustionFaintAveragePeriod | 300.000000 | How often (on average, in real time) should player faint when extremely exhausted (exhaust stat is on 0).
FactionAngrinessDecayBase | 2.000000 | Faction angriness decay speed base, whatever it is.
FactionAngrinessDecayExp | 2.000000 | Faction angriness decay speed exponent.
FactionAngrinessDecayMod | 0.000020 | Faction angriness decay speed mod, whatever it is.
FactionAngrinessDecayShift | 0.250000 | Faction angriness decay speed shift.
FactionAngrinessPropagationCoef | 1987.000000 | Faction angriness is propagated through space between factions.
FactionAngrinessPropagationScale | 0.100000 | Faction angriness propagation distance scale.
FactionRepWeight | 3.000000 | Weight of player - faction reputation (reputation median)
FallDamageMultiplierAtMaxAgility | 0.666667 | fall damage multiplier when agility is maxed out
FatalFallHeight | 8.000000 | falling height above which fatal health damage is taken at agility 0
FatCollisionWeightMul | 1.400000 | multiplies the archetype body weight if the character is fat
FoodFull | 100.000000 | you are full
...
FullClothDirtyingOnZeroSpeed | 4000.000000 | how far do we walk with half speed to get 100% dirty (other speeds than FullSpeed and HalfSpeed are linearly interpolated)
GoodArmorDefense | 2.000000 | mainly for AI, used to judge armor
GoodWeaponAttack | 3.500000 | mainly for AI, used to judge weapon
GoodWeaponDefense | 4.500000 | 
HarmlessFallHeight | 1.000000 | falling height below which no health or stamina damage is taken at agility 0
HeadHitKnockOutBaseProbability | 0.000000 | for hits dealing a hp damage
HealthDamageToInjury | 0.020000 | note: health is [0-100] but injury is [0-1]
HealthDeltaAbsLimit | 1000.000000 | abs max of health delta
HealthFadingFromLimitValue | 0.750000 | health percentage to activate health fading buff
HealthFull | 100.000000 | maximum health
HealthToKnockOut | 0.000000 | threshold for unarmed combat, health cannot reach this level
HealthToMoraleMinCoef | 0.200000 | multiplicative coef for health = 0
HearingToFov | 3.000000 | 
HeavyWeaponWeight | 4.000000 | used to deduce 'attack weight'
HerbGatherSkillToCount | 0.300000 | multiplied by sqrt(skill level) to modify the number of collected herbs
...
InjuryBleedingInterval | 6.000000 | bleeding interval, the time required to lose 1HP
InjuryHighThreshold | 0.800000 | limb is bleeding if above this threshold
InjuryLowThreshold | 0.200000 | limb is considered healthy if below this treshold
InjuryRegenInterval | 10.000000 | injuries fade-out, the time required to regen 1% of injury
ItemDisappearingMulti | 3.000000 | multiplier 1/x - x limit(up/down) for item disappearing speed in extremes (cheap vs. expensive, small vs. large)
ItemHealthPriceStatusWeight | 1.000000 | item health status weight price coef
ItemOwnerDescFadeToSuspiciencyExp | 0.250000 | 
ItemOwnerFactionDistanceCoef1 | 500.000000 | 
ItemOwnerFactionDistanceCoef2 | 300.000000 | 
ItemOwnerFactionDistanceToSuspiciencyMax | 1.000000 | 
ItemOwnerFactionDistanceToSuspiciencyMin | 0.250000 | 
ItemOwnerFadeCoefToSuspiciencyExp | 3.000000 | 
ItemOwnerFadeCoefToSuspiciencyMul | 2.000000 | 
ItemOwnerFadeConspicuousnessToHours | 10.000000 | world time hours
ItemOwnerFadePriceToHours | 1.000000 | world time hours per decigrosh
...
LockPickingFailRelativeXPMulCoef | 0.101563 | multiplicative constant to derive XP reward relative to the success
...
LockPickingSuccessXPMulCoef | 18.000000 | multiplicative constant to derive XP reward for a successfully opened lock
LockPickingToleranceACoef | 0.450000 | the lockpicking tolerance formula
LockPickingToleranceKCoef | 0.070000 | the lockpicking tolerance formula
LockPickingToleranceMCoef | 0.687000 | the lockpicking tolerance formula
LockPickingToleranceNCoef | 0.480000 | the lockpicking tolerance formula
LockPickingTurnBackDivCoef | 0.100000 | constant used in the denominator to derive the turnback speed of a lock
LockPickingTurnBackMulCoef | 5.000000 | multiplicative constant to derive the turnback speed of a lock
LowHealthThreshold | 40.000000 | threshold for low health effects (for npcs)
MatPierceableMaxArmor | 10.000000 | armor of a rock-solid material
MatPierceableMin | 6.000000 | OBSOLETE: projectiles with stab damage can stab into
...
MaxFencingWeaponUsageMod | 0.200000 | relative weapon status damage for max fencing
MaxHearingSoundAttenuationCoef | 0.200000 | minimal attenuation for non-zero hearing stat
MaxItemDisappearingTime | 32400.000000 | max game time for dropped items to disapper
MaxLightProbeValue | 65.000000 | value for the max visibility
MaxModConspicuousness | 1.000000 | final modified conspicuousness stat maximum (the most conspicuous actor)
MaxModVisibility | 3.500000 | final modified visibility stat maximum (the most visible actor)
MaxMorale | 1.000000 | max deriv stat value
MaxPedalCost | 2.000000 | pedaling STA cost (pressure 1)
MaxPerfectBlockSlotModifier | 0.800000 | modifier of PB slot window - determined as (t_hit - t_pbslot) from attack * this value.
MaxPerkPoints | 10.000000 | total number of perk points player will gain per stat/skill
...
OversleepnessEmptyTime | 12.000000 | how long (in game hours) does it take to empty the oversleepness stat (time player have to be awake to be able to sleep max time again)
OversleepnessFillTime | 12.000000 | how long (in game hours) does it take to fill the oversleepness stat (max time player can sleep)
PerceivedSuperfactionImportanceThresholdRel | 0.333333 | superfaction items must occupy more than this for the soul to look like the superfaction
PerceptionBaseCha | 10.000000 | 
PerceptionMaxFov | 180.000000 | the maximal field of view a superman NPC will have
PerceptionMeanDist | 5.000000 | 
PerceptionMinFov | 90.000000 | the minimal field of view a deaf NPC will have
PerceptionPriorBoostPlayer | 12.000000 | boost for player
PerceptionPriorBoostRangedWeapon | 100.000000 | boost for ranged weapons (multiplied by PriorWeapon!)
PerceptionPriorCha | 0.300000 | 
PerceptionPriorConsp | 3.000000 | 
PerceptionPriorCrimeLockpick | 12.000000 | 
PerceptionPriorCrimeLoot | 12.000000 | priority boost for crime
PerceptionPriorDead | 25.000000 | dead or unconscious
PerceptionPriorDist | 2.000000 | 
PerceptionPriorEnemyRelationship | -50.000000 | 
PerceptionPriorFriendRelationship | -4.000000 | 
PerceptionPriorGender | 2.000000 | 
PerceptionPriorNotHumanRace | -15.000000 | 
PerceptionPriorTarget | 10.000000 | target priority estimation
PerceptionPriorThreatened | -5.000000 | 
PerceptionPriorVisCrimes | 6.000000 | 
PerceptionPriorVisItems | 0.500000 | 
...
PerkWaterOfLifeHealthMultiplier | 1.500000 | potion health effect multiplier for Water of life perk
PicklockDmgSpeed | 10.000000 | how fast is picklock durability decreasing (will be multiplied by the relative distance)
...
SharpeningMaxDestructionAngle | 0.700000 | 
SharpeningMaxIdealAngle | 0.500000 | 
SharpeningMinDestructionAngle | 0.600000 | 
SharpeningMinEfficiencyHealth | 0.300000 | health you can achieve with the worst efficiency
SharpeningMinIdealAngle | 0.300000 | 
SharpeningSuccessfulHealthDelta | 0.100000 | 
ShoeHealthDecrease | 0.001000 | status delta per traveled m
...
SkillXPDrinkAlcohol | 1.000000 | XP gain per 1 alcohol content drinked
SkillXPHit | 2.000000 | weapon XP gain after a hit
SkillXPKill | 12.000000 | weapon XP gain after a kill
SkillXPLevelBase | 20.000000 | base value (additive) to calculate XPs needed for the next level
SkillXPLevelDiff | 30.000000 | multiplicative value to calculate XPs needed
SkillXPPerfectBlock | 8.000000 | XP gain after a successful perfect block
SkillXPRiposte | 8.000000 | successful riposte (attack after perfect block)
SkillXPUseRepairKit | 5.000000 | XP gain per 1 health repaired by repairkit
SleepHealthRegenBaseSpeed | 0.003472 | full regen after 8 world-time hours
SleepToSaveThreshold | 1.000000 | sleeping at least this time triggers autosave.
SlimCollisionWeightMul | 0.800000 | multiplies the archetype body weight if the character is slim
SoulCourageMoraleWeight | 5.000000 | Weight of soul courage affecting morale
SpeechDiffToSkillCheckResult | 0.300000 | > 0; speech diff for result = -1/1
...
StaminaToHealthDamageMin | 0.250000 | stamina-health damage transfer for dmgr=0
StamRegenBase | 22.000000 | base regeneration speed
StamRegenBlockMod | 0.600000 | relative stam regen speed during active block or raised weapon
StamRegenCooldown | 1.500000 | cooldown timer expiry
...
StillBuffDuration | 600.000000 | duration of standing still after which Still buff bonuses are activated (in worldtime seconds)
StolenGoodsForcedDiscount | 0.400000 | price multiplier for when merchant detects that the sold items are stolen
