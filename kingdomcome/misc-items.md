...
--- | --- | --- | --- | --- | --- | ---
`10ef5335-7e57-4acc-92a0-7b0b239f8c6c` | Adam's family cross | `200.0` | `1.0` | `false` | Besmirched (`subchapter_303_name`) | Inventory: `neu_ondrej_chest1`
`0ce2975a-d777-44e7-96b4-50f24d015b6c` | Andrew's tankard | `0.0` | `0.0` | `true` | Sheep in Wolf's Clothing (`subchapter_558_name`) | Inventory: `tal_martin`
`8aec9e19-a943-4d26-acc9-844acdcfa90b` | Bandit leader's spurs | `0.0` | `0.0` | `true` | Interlopers (`subchapter_596_name`) | Inventory: `a_camp_proof10`<br>Looted from Bandit at Skalitz (`ska_enemy_camp_leader_10`)
`fcd5926b-7fbd-47ab-91c2-a2ffef316fa5` | Bandit leader's spurs | `0.0` | `0.0` | `true` | Interlopers (`subchapter_596_name`) | Inventory: `a_camp_proof11`<br>Looted from Bandit at Skalitz (`ska_enemy_camp_leader_11`)
`7b7e898e-ac66-4d26-8a6c-b2a87e5abc90` | Bandit leader's spurs | `0.0` | `0.0` | `true` | Interlopers (`subchapter_596_name`) | Inventory: `a_camp_proof12`<br>Looted from Bandit at Samopesh (`sam_enemy_camp_leader_12`)
`5c76130f-edf5-43a8-a4a9-90ff30302606` | Bandit leader's spurs | `0.0` | `0.0` | `true` | Ruin (`subchapter_586_name`) | Inventory: `a_camp_proof1`<br>Looted from Bandit (`rato_enemy_camp_leader_1`)
`96b84458-9847-49df-9276-6c50f5ea7c6d` | Bandit leader's spurs | `0.0` | `0.0` | `true` | Ruin (`subchapter_586_name`) | Inventory: `a_camp_proof2`<br>Looted from Bandit at Vranik (`vra_enemy_camp_leader_2`)
`0e06c953-0409-4459-947f-9c37d56191e2` | Bandit leader's spurs | `0.0` | `0.0` | `true` | Ruin (`subchapter_586_name`) | Inventory: `a_camp_proof3`<br>Looted from Bandit at Neuhof (`neu_enemy_camp_leader_3`)
`1b5c172b-f1af-4852-acba-29ebdafc3cc9` | Bandit leader's spurs | `0.0` | `0.0` | `true` | Ruin (`subchapter_586_name`) | Inventory: `a_camp_proof4`<br>Looted from Bandit at Ledetchko (`led_enemy_camp_leader_4`)
`42f77dc8-da5e-4dfe-9f79-f35295831e92` | Bandit's cloak | `0.0` | `0.0` | `true` | The Hunt Begins (`subchapter_393_name`) | 
`04ab1ca6-7403-4700-9557-af97a91add71` | Bandit's ear | `0.0` | `0.0` | `true` |  | 
`424ca78a-c782-42ad-bdf2-6e45d0720e0b` | Bandit's trunk key | `0.0` | `0.0` | `false` |  | Inventory: `q_flirtTalmberk_vltavinKey`
`bfa29926-6110-405b-a59b-6320f2d15a88` | Bandit's trunk key | `0.0` | `1.0` | `false` |  | Inventory: `TA04_OurLittleHouse:Ondras`<br>Looted from Guard at Talmberg (`tal_ondras`)
`6f093d6e-49ad-470e-9c24-105007a98a8b` | Bandit's trunk key | `0.1` | `0.0` | `true` | Locked Out (`subchapter_284_name`) | Inventory: `rat_vekosPruda`<br>Inventory: `sam_herbalist`<br>Looted from Herbalist (`sam_herbalist`)
`5004e2a4-2f20-481a-afdd-cf7a71781bbb` | Bandit's trunk key | `0.1` | `1.0` | `false` |  | 
`3e950df1-e625-4da1-88b7-280fb33d32de` | Barn key | `0.0` | `0.0` | `true` |  | Inventory: `mrh_devecka`<br>Looted from Villager at Merhojed (`mrh_devecka`)
`7448efc8-baab-4906-8e0d-40e0c4396594` | Beer recipe | `0.0` | `0.0` | `false` | Thick as Thieves - Simon (`subchapter_590_name`) | 
`b16db2b4-788a-4a04-8b9a-6ecfebcfc8ec` | Beran's cup | `200.0` | `2.0` | `false` | Scavenger (`subchapter_374_name`) | Inventory: `q_debtor_beransTreasure_REAL`
`12c04d37-2cac-454a-917f-4cf0964758fe` | Bird trap | `0.0` | `2.0` | `true` |  | 
`bec48698-4b03-4bdc-a012-9f439bfc4cd7` | Bloody hoof-pick | `0.0` | `0.0` | `true` | The Hunt Begins (`subchapter_393_name`) | 
`e0a9faa2-46d4-4b4e-a619-9a56c1c29007` | Boar hide | `70.0` | `4.0` | `false` | Skin (`subchapter_616_name`) | Inventory: `shed_tools`<br>Sold by tanner at Rattay (`rat_tanner`)<br>Sold by tanner at Talmberg (`tal_tanner`)
`3ee1b3bb-4b81-4ce8-ac41-cfdd68e81063` | Bone | `10.0` | `0.0` | `true` | Saintly Remains (`subchapter_478_name`) | Inventory: `q_urbans_bone_corpse`
`674bfdec-8c01-4cfd-9db2-3da74667ee0e` | Bone powder of St. Thomas | `4.0` | `0.0` | `false` |  | Sold by Charlatan at Sassau (`sas_charlatan_shop`)
`a7186135-4a2a-4b3f-aab9-b916f3fc8b8c` | Borya's key | `0.0` | `1.0` | `false` |  | Inventory: `jak_borja`<br>Looted from Borya at Rovna (`jak_borja`)
...
`f1d3da41-49a2-41bb-9c61-8180da53718e` | Dead man's ring | `0.0` | `0.0` | `true` | The Good Thief (`subchapter_208_name`) | Inventory: `exechermanchest`<br>Inventory: `rataje_executioner_quest_chest`
...
`9689affb-0d84-4e64-ba8b-8549c79ac7bc` | Hare's ring | `0.0` | `0.0` | `true` | Hare Hunt (`subchapter_300_name`) | Inventory: `tal_zajic`<br>Looted from Hanekin Hare at Talmberg (`tal_zajic`)
...
`8d76f58e-a521-4205-a7e8-9ac077eee5f0` | Lockpick | `15.0` | `0.1` | `false` | A Needle in a Haystack (`subchapter_442_name`)<br>Libri Prohibiti (`subchapter_429_name`)<br>Nasty Habits (`subchapter_410_name`)<br>Unexpected Visit (`subchapter_298_name`) | Inventory: `aus_bohuta`<br>Inventory: `e3_weapon_chest`<br>Inventory: `event thief pockets`<br>Inventory: `hangover_stash_small2`<br>Inventory: `mrh_alpha_chest4`<br>Inventory: `mrh_armyCamp_chest2`<br>Inventory: `mrh_home5_chest`<br>Inventory: `q_escape_from_Vranik_2`<br>Inventory: `sam_blacksmith`<br>Inventory: `saso_pejchar_torch`<br>Inventory: `saso_pejchar`<br>Inventory: `ska_fricek`<br>Looted from Bandit at Random Event (`event_chase_thief2`)<br>Looted from Bandit at Random Event (`event_chase_thief`)<br>Looted from Blacksmith at Samopesh (`sam_blackSmith1`)<br>Looted from Father Godwin at Uzhitz (`aus_bohuta`)<br>Looted from Fritz (`ska_fricek`)<br>Looted from Peychar at Sassau (`saso_pejchar`)<br>Quest reward: What a Strange Day... (`subchapter_523_name`)<br>Sold by fisherman at Talmberg (`tal_fishFarmerShop`)<br>Sold by innkeeper at Inn in the Glade (`cross_pub_innkeeper`)<br>Sold by miller at Budin (`bud_miller`)<br>Sold by miller at Kohelnitz (`kuch_miller`)<br>Sold by miller at Ledetchko (`led_miller`)<br>Sold by miller at Rattay (`rat_miller`)<br>mon_cellarius_lockpicks_shop
...
`0d8a9d20-fa8f-4044-9579-2b63ff7cfd5a` | Pouch with amulet | `0.0` | `0.0` | `true` | Green-Eyed Monster (`subchapter_603_name`) | 
...
`c5a4b52b-2e05-4233-9d6f-2d7e283b71cc` | Venetian glass chalice | `65.0` | `0.5` | `false` |  | Inventory: `neu_ondrej_chest1`<br>Inventory: `q_flirtTalmberk_vltavin`
