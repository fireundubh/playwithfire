...
Herbalism Skill | Number of collected herbs | `RPG.HerbGatherSkillToCount * sqrt(skillLevel`
Herbalism Skill | Radius of herb collection | `RPG.HerbGatherSkillToRadius * skillLevel`
